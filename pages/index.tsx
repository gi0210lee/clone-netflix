...
const Home: NextPage = () => {
  ...
  // cn(`base styles`, isLoading && `spinner`)
  return (
    <div
    ...
    >
      ...
      <header className="flex w-full justify-between px-12 py-8 text-white">
        <div>
          <svg
      ...
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center text-white">
        <h1 className="max-w-sm text-5xl font-medium font-bold tracking-wide">
          Unlimited movies, TV shows, and more
        </h1>
        <h2 className="mt-4 mb-8 text-2xl">Watch anywhere. Cancel anytime.</h2>
        <p className="text-lg">
          Ready to watch? Enter your email to create or restart your membership.
        </p>
        <div className="mt-4 flex">
          <input
            placeholder="Email addrass"
            className="min-w-[400px] bg-white p-4"
          />
          <button className="flex items-center bg-[#e50914] px-8 text-lg">
            Get Started
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-5"
